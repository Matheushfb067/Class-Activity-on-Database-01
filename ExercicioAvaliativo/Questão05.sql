...
Para essa atividade, considere que os Mundos considerados nas atividades anteriores sejam cadastrados. 
...
insert into personagens(id_personagens, nome, idade, profissao, data_criacao, id_mundos)
values
(1, "Ann`aurora	", 21, "Clérigo(a)", "2024-06-05", 1),
(2, "Zurendownr Narrwack", 652, "Diplomata", "2024-06-05", 1);
